...
def create_initial_team_data():
    ...
    df_list = []
    for year in teamId_dict:
        team_df = pd.DataFrame(teamId_dict[year], columns=['teamId', 'full_name', 'manual_nickname'])
        team_df['year'] = year
        
        df_list.append(team_df)
        
    team_df = pd.concat(df_list)
...
if __name__ == '__main__':
    ...
    print(all_team_df)
    # team_df = all_team_df.loc[all_team_df['year'] == 2020]
    # print(team_df)
    # print(all_team_df)
