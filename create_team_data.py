...
def create_initial_team_data():
    ...
    team_df_2022 = pd.DataFrame(teamId_dict['2022'], columns=['teamId', 'full_name', 'manual_nickname'])
    team_df_2022['seasonId'] = 2022

    team_df_all_seasons = pd.concat([team_df_2019, team_df_2020, team_df_2021, team_df_2022])
